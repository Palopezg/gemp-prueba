...
export class JobHistoryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('gempApp.jobHistory.delete.question'));
...
export default class JobHistoryComponentsPage {
  ...
  async deleteJobHistory() {
    ...
    expect(await jobHistoryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/gempApp.jobHistory.delete.question/);
