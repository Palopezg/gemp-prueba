...
export class TaskDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('gempApp.task.delete.question'));
...
export default class TaskComponentsPage {
  ...
  async deleteTask() {
    ...
    expect(await taskDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/gempApp.task.delete.question/);
