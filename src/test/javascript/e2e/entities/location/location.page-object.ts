...
export class LocationDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('gempApp.location.delete.question'));
...
export default class LocationComponentsPage {
  ...
  async deleteLocation() {
    ...
    expect(await locationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/gempApp.location.delete.question/);
