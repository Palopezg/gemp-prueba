...
export class JobDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('gempApp.job.delete.question'));
...
export default class JobComponentsPage {
  ...
  async deleteJob() {
    ...
    expect(await jobDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/gempApp.job.delete.question/);
